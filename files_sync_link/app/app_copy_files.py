...
from files_sync_link.controllers.copy_files import CopyFilesController
from files_sync_link.actions.copy_fs_file import CopyFileAction
from files_sync_link.actions.glob_fs_files import GlobFsFilesAction
from files_sync_link.actions.delete_fs_file import DeleteFileAction
from files_sync_link.actions.file_space_usage import DirSpaceUsage
...
class DistributeFilesApp:
    ...
    def __init__(self, cfg, stop_on_loop):
        ...
        self.file_sources = cfg["file_sources"]
        self.check_timeout = cfg["scheduler"]["file_check_timeout"]
    ...
    async def run(self):
        self.log.info("Alive")
        self.controller = CopyFilesController(
            GlobFsFilesAction(), CopyFileAction(), DeleteFileAction(),
            DirSpaceUsage(), LimitConcurrencyAction(), self.file_sources, self.tasks_limit
        )
...
if __name__ == "__main__":
    ...
    try:
        ...
        logging.info(f"Main Finished {args.stop_on_loop}")
